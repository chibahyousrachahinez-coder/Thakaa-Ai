...
export const INITIAL_TOOLS: Tool[] = [
  ...
  { id: 51, name: "Andi",           category: "productivity", domain: "andisearch.com",     icon: "", desc: "Generative AI-powered search engine that provides direct answers.", price: "Free", pricing: "free", arabic: "no", opensource: false, rating: 4.6, featured: false, tags: ["free"], url: "https://andisearch.com" },
  { id: 52, name: "Cody",           category: "business",    domain: "meetcody.ai",         icon: "", desc: "AI assistant transforming business knowledge management.", price: "Free Trial", pricing: "freemium", arabic: "no", opensource: false, rating: 4.4, featured: false, tags: ["freemium"], url: "https://meetcody.ai" },
  { id: 53, name: "REimagine Home", category: "design",      domain: "reimaginehome.ai",    icon: "", desc: "Generative AI to redesign any room in seconds.", price: "Free", pricing: "free", arabic: "no", opensource: false, rating: 4.5, featured: false, tags: ["free"], url: "https://reimaginehome.ai" },
  { id: 54, name: "Cursor",         category: "code",        domain: "cursor.com",          icon: "", desc: "AI-first code editor built for developers.", price: "Free / $20mo", pricing: "freemium", arabic: "no", opensource: false, rating: 4.9, featured: true, tags: ["freemium"], url: "https://cursor.com" },
  { id: 55, name: "Tabnine",        category: "code",        domain: "tabnine.com",         icon: "", desc: "Rapid, secure coding with AI-driven personalized suggestions across IDEs.", price: "Free Trial", pricing: "freemium", arabic: "no", opensource: false, rating: 4.6, featured: false, tags: ["freemium"], url: "https://www.tabnine.com" },
  { id: 56, name: "Qodo",           category: "code",        domain: "qodo.ai",             icon: "", desc: "Turns PR history into enforceable code standards and testing.", price: "Free Trial", pricing: "freemium", arabic: "no", opensource: false, rating: 4.5, featured: false, tags: ["freemium"], url: "https://www.qodo.ai" },
  { id: 57, name: "Windsurf",       category: "code",        domain: "codeium.com",         icon: "", desc: "Streamline coding with predictive AI, deployment, and integration.", price: "Free / $10mo", pricing: "freemium", arabic: "no", opensource: false, rating: 4.8, featured: true, tags: ["freemium"], url: "https://codeium.com/windsurf" },
  { id: 58, name: "ROK Solution",   category: "productivity", domain: "roksolution.com",   icon: "", desc: "Streamlines operations with no-code apps and hyperautomation.", price: "Free Trial", pricing: "freemium", arabic: "no", opensource: false, rating: 4.3, featured: false, tags: ["freemium"], url: "https://www.roksolution.com" },
  { id: 59, name: "Amazon SageMaker", category: "data",      domain: "aws.amazon.com",      icon: "", desc: "AI-powered tool for precise, scalable business forecasting.", price: "Free Tier", pricing: "freemium", arabic: "no", opensource: false, rating: 4.7, featured: false, tags: ["freemium"], url: "https://aws.amazon.com/sagemaker" },
  { id: 60, name: "Akkio",          category: "data",        domain: "akkio.com",           icon: "", desc: "Transform data into predictive power effortlessly, no coding needed.", price: "Free Trial", pricing: "freemium", arabic: "no", opensource: false, rating: 4.5, featured: false, tags: ["freemium"], url: "https://www.akkio.com" },
  { id: 61, name: "Browse AI",      category: "productivity", domain: "browse.ai",          icon: "", desc: "Effortlessly extract and monitor web data without coding.", price: "Free / $19mo", pricing: "freemium", arabic: "no", opensource: false, rating: 4.6, featured: false, tags: ["freemium"], url: "https://www.browse.ai" },
  { id: 62, name: "InsightBase",    category: "data",        domain: "insightbase.ai",     icon: "", desc: "AI-driven analytics, no-code interface, custom coding options.", price: "Free / $24mo", pricing: "freemium", arabic: "no", opensource: false, rating: 4.4, featured: false, tags: ["freemium"], url: "https://insightbase.ai" },
  { id: 63, name: "Blaze SQL",      category: "data",        domain: "blazesql.com",        icon: "", desc: "Revolutionize data analytics with AI-driven, no-code SQL query generation.", price: "From $29/mo", pricing: "paid", arabic: "no", opensource: false, rating: 4.5, featured: false, tags: ["paid"], url: "https://www.blazesql.com" },
  { id: 64, name: "AI2sql",         category: "data",        domain: "ai2sql.io",           icon: "", desc: "Transforms natural language into SQL queries effortlessly.", price: "Free / $19mo", pricing: "freemium", arabic: "no", opensource: false, rating: 4.4, featured: false, tags: ["freemium"], url: "https://www.ai2sql.io" },
  { id: 65, name: "OSS Insight",    category: "data",        domain: "ossinsight.io",       icon: "", desc: "Unleash GitHub data insights with AI-powered SQL and real-time analytics.", price: "Free", pricing: "free", arabic: "no", opensource: true, rating: 4.8, featured: false, tags: ["free", "opensource"], url: "https://ossinsight.io" },
];
